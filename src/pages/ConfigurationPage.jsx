...
const ConfigurationPage = () => {
    ...
    const fetchApiData = async () => {
      try {
        ...
        const response = await fetch(
          "https://apibackend-7rz1.onrender.com/api/unique-routes"
        );
  ...
  const handleMoreClick = async (api, event) => {
    ...
    try {
      const response = await fetch(
        `https://apibackend-7rz1.onrender.com/api/setconfig/${api.apiKey}?path=${api.apiName}`
      );
  ...
  const handleSaveControls = async () => {
    ...
    try {
      const response = await fetch(
        "https://apibackend-7rz1.onrender.com/api/config",
        {
          method: "POST",
